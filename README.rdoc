...
The result: link:rgl/examples/example.jpg
...
produces module_graph.jpg: link:rgl/examples/module_graph.jpg

Look for more in the examples directory (i.e.
examples.rb[link:rgl/examples/examples.rb]).
...
Jeremy Bopp, John Carter, Sascha Doerdelmann, Shawn Garbett and Andreas Schörk
