= Ruby Graph Library (RGL) {<img src="https://secure.travis-ci.org/monora/rgl.png?branch=master" alt="Build Status" />}[https://travis-ci.org/monora/rgl] {<img src="https://codeclimate.com/github/monora/rgl/badges/gpa.svg" />}[https://codeclimate.com/github/monora/rgl] {<img src="https://codeclimate.com/github/monora/rgl/badges/issue_count.svg" />}[https://codeclimate.com/github/monora/rgl] {<img src="https://codeclimate.com/github/monora/rgl/badges/coverage.svg" />}[https://codeclimate.com/github/monora/rgl/coverage]
...
* An interface for how the structure of a graph can be accessed using a generic
  ...
  implementation. This interface is defined by the module {RGL::Graph}, which should be
...
stream[http://www.rubydoc.info/github/monora/stream] module. The third one is
...
Look for more in {examples}[link:examples/examples.rb] directory.
...
documentation as a _cheap_ reference for RGL. He and Robert also gave feedback
...
RGL is Copyright (c) 2002,2004,2005,2008,2013,2015 by Horst Duchene. It is free
software, and may be redistributed under the terms specified in the README file
